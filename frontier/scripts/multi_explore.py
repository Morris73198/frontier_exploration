...
class Costmap2DClient:
    def __init__(self):
        ...
        self.costmap_topic = rospy.get_param('~costmap_topic', 'map')
        self.costmap_received = False
        self.costmap_sub = rospy.Subscriber(self.costmap_topic, OccupancyGrid, self.costmap_callback)
        rospy.loginfo(f"Initializing Costmap2DClient with robot_base_frame: {self.robot_base_frame}, global_frame: {self.global_frame}")
